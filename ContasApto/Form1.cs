    ...
    public partial class frmPrincipal : Form
    {
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            if ((txtOutros.Text == "") || (txtAluguel.Text == "") || (txtCondominio.Text == "") || (txtEnergia.Text == "") || (txtGas.Text == "") ||
                (txtNet.Text == "") || (txtQtdmoradores.Text == ""))
            {
                 MessageBox.Show(" Favor preencher todos os campos com um valor válido ou inserir 0 ");
            }
            else
            {
                ...
                qtdMoradores = Convert.ToDouble(txtQtdmoradores.Text);
